...
USE_REMBG_BACKGROUND_REMOVAL = (
    False
    if os.getenv("RENDER")
    else os.getenv("USE_REMBG_BACKGROUND_REMOVAL", "True").lower() == "true"
)
REMBG_MODEL = "u2netp" if os.getenv("RENDER") else os.getenv("REMBG_MODEL", "u2netp").strip()
